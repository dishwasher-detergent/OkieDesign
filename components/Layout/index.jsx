    ...
    return (
        <div className="flex flex-col w-full min-h-screen relative">
            <div className="flex-1">
                ...
                <main>
                    <section className="max-w-6xl mx-auto py-12 md:py-24 px-4">
                        ...
                        <p className="text-slate-600 md:text-xl text-center">Responsive CSS components made with TailwindCSS and Love.</p>
                    ...
                    <section className="max-w-6xl w-full h-full mx-auto z-30">
                        {children}
                    </section>
                </main>
            </div>
